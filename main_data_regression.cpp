...
int main(int argc, char** argv){
    ...
    */
	...
	int cnt_s_after = 0;
	int cnt_r = 0;
	float steer_folder[500];
	float steer_folder_total[2000];
	int index_temp = 0;
	int index_ = 0;
	int index_total = 0;
...
/*        bool valid = generate_path_RRT();
		...
		int inum = rand() % 10000;
        oss << "/home/wooseoko/catkin_ws/src/project2/color_data_regression/" << inum;
		oss1 << "/home/wooseoko/catkin_ws/src/project2/color_data_regression/";
            ...
            case RUNNING: {
		        ...
		        while(ros::ok()) {
        	        ...
        	        ofs << "\n";
						...
						steer_folder[index_] = cmd.drive.steering_angle;
						steer_folder_total[index_total+index_]=cmd.drive.steering_angle;
						index_++;
